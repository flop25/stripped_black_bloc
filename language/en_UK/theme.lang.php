<?php
$lang['The parent-theme Stripped need to be enabled in order to use its parameters'] = 'The parent-theme Stripped must be enabled in order to use its parameters';
...
$lang['(it need to be inferior than the width of columns)'] = "(it needs to be strictly smaller than the width of columns)";
$lang['About portrait/landscape pictures :'] = "About portrait/landscape pictures (Note that the plugin auto-manages the thumbnails of panoramas):";
$lang['No Maximum Height and the width is the one set above'] = "No Maximum Height and the width is the one set above";
$lang['Use the width parameter above as a maximum heigth'] = "Use the width parameter above as a maximum heigth";
$lang['Display big thumbnails for landscape pictures'] = "Display big thumbnails for landscape pictures";
