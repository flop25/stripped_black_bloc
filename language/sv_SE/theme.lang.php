...
// | USA.                                                                  |
// +-----------------------------------------------------------------------+
$lang['(it need to be inferior than the width of columns)'] = '(den måste vara strikt lägre än kolumnbredden)';
$lang['(set 0 to disable)'] = '(välj 0 för att avaktivera)';
$lang['... starting to the position number'] = '... börjar med postitionsnummer';
$lang['About big thumbnails, for the albums :'] = 'Om stora miniatyrer, för album:';
$lang['Create a big thumbnail every'] = 'Skapa en stor miniatyr var:';
